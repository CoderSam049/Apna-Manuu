...
export default function Home() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              Code, Learn, and Build your dream projects with us. We provide the
      ...
      <section
        id="get-start"
        className="py-20 px-5 md:px-20 bg-gray-900 text-white"
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              ...
              Unleash your geekiness and make a difference in technology. Join
              us to innovate, learn, and grow together.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          ...
          >
            ...
            <p className="text-gray-300">
              Enhancing coding culture via regular classes, contests, and geeky
              sessions on campus.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">
              Growing as a strong coding community, impacting various fields,
              upholding integrity worldwide.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h1>Python</h1>
              <p>
                Python is a high-level, easy-to-learn programming language with
                simple syntax...
              </p>
            </motion.div>
            ...
            >
              ...
              <p>
                Machine Learning enables AI systems to improve performance
                automatically...
              </p>
            </motion.div>
            ...
            >
              ...
              <p>
                ...
                that run on mobile devices, such as smartphones and tablets, or
            ...
            >
              ...
              <p>
                AI enhances automation, personalization, and predictive
                analytics...
              </p>
            </motion.div>
          </div>
